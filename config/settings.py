...
SECRET_KEY = os.environ.get(
    "SECRET_KEY",
    "django-insecure-n_)mivy_b$^r8!b6_2c1#%hlhl*t^ff$35rbuhq9*o#@4712v2",
)
...
DATABASES = {
    "default": {
        ...
        "NAME": os.environ.get("POSTGRES_DB", "videogame_store"),
        "USER": os.environ.get("POSTGRES_USER", "gamedev"),
        "PASSWORD": os.environ.get("POSTGRES_PASSWORD", "gamedev123"),
